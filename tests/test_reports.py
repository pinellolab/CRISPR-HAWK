from crisprhawk.reports import (
    ...
    parse_variant_ids,
    _check_variant_ids,
    _collapse_haplotype_ids,
    _collapse_annotation,
    _collapse_offtargets,
    _collapse_cfd,
)
...
def test_compute_pam_class():
    ...
    assert _compute_pam_class(pam) == "[ACGT]GG"
    pam2 = PAM("TTTV", True, False)
    assert _compute_pam_class(pam2) == "TTT[ACG]"
