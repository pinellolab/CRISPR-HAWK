...
def crisprhawk(args: CrisprHawkInputArgs) -> None:
    ...
    guides = annotate_guides(guides, args.functional_annotation, args.gene_annotation, pam, args.fasta, args.estimate_offtargets, args.write_offtargets_report, args.outdir, args.verbosity, args.debug)
    # construct reports
    report_guides(guides, args.guidelen, pam, bool(args.functional_annotation), bool(args.gene_annotation), args.estimate_offtargets, args.outdir, args.verbosity, args.debug)
